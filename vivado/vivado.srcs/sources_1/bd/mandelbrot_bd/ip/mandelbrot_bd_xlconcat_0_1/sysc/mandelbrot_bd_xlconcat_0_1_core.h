...
#ifndef _mandelbrot_bd_xlconcat_0_1_core_h_
#define _mandelbrot_bd_xlconcat_0_1_core_h_
...
class mandelbrot_bd_xlconcat_0_1_core : public sc_module 
{
    public: 
       mandelbrot_bd_xlconcat_0_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(mandelbrot_bd_xlconcat_0_1_core);
    ...
    virtual ~mandelbrot_bd_xlconcat_0_1_core() = default;
